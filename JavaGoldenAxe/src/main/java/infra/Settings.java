...
public class Settings {
    ...
    public static Color DEBUG_COLLIDERS_ATTACK_COLOR = new Color(255, 128, 128, 128);
    public static Color DEBUG_COLLIDERS_FIRE_COLOR = new Color(255, 255, 0, 128);
    public static Color DEBUG_COLLIDERS_TOUCH_COLOR = new Color(255, 0, 0, 128);
