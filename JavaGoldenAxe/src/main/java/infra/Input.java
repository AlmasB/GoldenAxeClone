...
public class Input implements KeyListener {
    ...
    private static final Map<Integer, long[]> KEYS_DOUBLE_PRESSED = new HashMap<>();
    ...
    public static synchronized boolean isKeyDoublePressed(int keyCode) {
        ...
        if (lastTimes != null) {
            if (lastTimes[0] > 0 && lastTimes[1] > 0) {
                result = Util.getTime() - lastTimes[1] <= DOUBLE_PRESSED_TIME && KEYS_PRESSED.contains(keyCode);
